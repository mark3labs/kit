...
<td>Switch model or open model selector. The selector lists every model in the catalogue; models whose provider has no credentials are dimmed and cannot be selected — use <code>/connect</code> to add a key.</td>
</tr>
<tr>
