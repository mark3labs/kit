...
<td>—</td>
<td>—</td>
<td>Add an MCP server for this run (repeatable). <code>name=command args...</code> starts a local stdio server; <code>name=https://...</code> connects to a remote server</td>
</tr>
</tbody>
</table>
...
replaces that entry for the run. For <code>environment</code>, <code>allowedTools</code>, <code>headers</code>
and the other per-server fields, use the <a href="/configuration#mcp-server-configuration">config file</a>.</p>
