...
require (
	...
	// Pinned: openai-go >= v3.51.0 changes the Responses API annotation field
	// from `any` to a typed union, which charm.land/fantasy v0.41.3 does not
	// compile against. Unpin once fantasy supports the newer SDK.
